#!/usr/bin/env python3
"""Batch scout — scrape 10 ASINs in sequence, generate briefings"""
...
# 10 ASINs across categories
ASINS = [
    'B00FLYWNYQ',   # Kitchen: Instant Pot Duo 7-in-1
    'B08DBVYJPZ',   # Kitchen: Cuisinart water filters (reused from coffee)
    'B07YN32XQL',   # Coffee: One Lucky Mama (or coffee-related)
    'B08N5KWB9H',   # Home: MacBook Air M1
    'B08412HXK9',   # Home: standing desk / monitor arm
    'B0D45PK5V4',   # Coffee/Kitch: recent
    'B01C4IDQS8',   # Coffee: popular coffee maker
    'B000MVV6AA',   # Home: webcam / office
    'B00CH9QWOU',   # Coffee: Chemex / pour-over
    'B000LTOCSG',   # Coffee: Aeropress / coffee accessory
]
...
for asin in ASINS:
    ...
    if not result:
        continue
    briefing = make_briefing(result['asin'], result['title'], result['price'],
...
print(f'\n{"="*50}')
print(f'✅ {success}/10 briefings generated')
print(f'📂 {BRIEFINGS_DIR}')
