...
# NOTE: Use bash, not zsh (no associative arrays in zsh)
...
# Using indexed arrays for macOS compatibility
KITCHEN_ASINS="B00FLYWNYQ B09TQ3XLGG B08B5L5P9K B07S2LH4T2 B08G17C5C1 B09FMPXNMY B06XDJ7T8W B09B9D3PLL B08D3Y5H3M B07G1XX7T2 B08HHDPJ7L B0B5G4YJRM B094R8QPB5 B0C1YP1SNM"
COFFEE_ASINS="B07985N4C9 B086RBYNNB B07YN32XQL B089MV1KMP B07TC7HJK2 B0CCCPK6ZQ B08GJHYNQF B09QGJQV8Q B07N4L3N5G B08DF3H6VL"
HOME_OFFICE_ASINS="B08N5KWB9H B09G9HDH9P B08J6F3DML B09B2C9MX7 B08HRD7BDL B093D99GDR B08VDRT4CL B0B8G4YJRM B07YLXY6T6 B07D3M7D3G"
...
for CAT in kitchen coffee home-office; do
  ...
  echo "--- $CAT ---"
  case $CAT in
    kitchen) ASINS="$KITCHEN_ASINS" ;;
    coffee) ASINS="$COFFEE_ASINS" ;;
    home-office) ASINS="$HOME_OFFICE_ASINS" ;;
  esac
  VALID_ASINS=""
