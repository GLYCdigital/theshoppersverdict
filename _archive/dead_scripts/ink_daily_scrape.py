#!/usr/bin/env python3
"""Ink daily scrape: 10 fresh ASINs from queue, standalone (no batch_scout import)."""
...
CATEGORY_ASINS = {
    'coffee':   [a for a in q['coffee'] if a not in used],
    'kitchen':   [a for a in q['kitchen'] if a not in used],
    'home-office': [a for a in q['home-office'] if a not in used],
}

# Pick: 4 coffee, 3 kitchen, 3 home-office
PICK = {
    'coffee':   CATEGORY_ASINS['coffee'][:4],
    'kitchen':   CATEGORY_ASINS['kitchen'][:3],
    'home-office': CATEGORY_ASINS['home-office'][:3],
}
...
print(f'\n{"="*50}')
print(f'✅ {total}/10 briefings generated')
