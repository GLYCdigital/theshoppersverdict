---
title: "Oatey Sure-Vent 1-1/2 in.–2 in. 160 Branch, 24 Stack DFU A"
seo_title: "Oatey Sure-Vent Review: 160 Branch DFU Air Admittance Valve"
meta_description: "Honest Oatey Sure-Vent 1-1/2–2 in. review: 160 branch DFU capacity, 24 stack DFU, install tips, and where this AAV falls short."
slug: "oatey-sure-vent-1-1-2-in-2-in-160-branch-24-b0cw5w-review"
image_alt: "Oatey Sure-Vent 1-1/2 to 2 inch branch air admittance valve with 160 DFU rating"
verdict_score: 4.6
date: 2026-08-06
price: null
review_count: 229
...
pros:
  - "Rated for 160 DFU on branch lines and 24 DFU on stack — handles serious fixture loads, not just a single sink"
  - "Fits both 1-1/2 in. and 2 in. pipe, so it adapts to common residential DWV layouts without extra reducers"
  - "Meets ASSE 1050 and UPC codes in most jurisdictions, making it a code-compliant choice for inspectors"
cons:
  - "Cannot be used as the sole vent for a septic system — a real limitation for rural installations"
  - "Requires 4 in. of accessible vertical pipe above the connection, which can be tight in cramped crawlspaces"
  - "Plastic body feels less robust than metal vent caps; careful wrench work needed to avoid cracking the hub"
---
...
**Q: Can I use this outdoors or in an unconditioned attic?**
A: No. AAVs are rated for indoor use only. Freezing temperatures can damage the diaphragm and cause it to fail permanently.

**Q: Does this replace the need for a roof vent entirely?**
A: In most residential applications, yes — as long as the system has at least one primary vent to the outdoors and you follow local code. It's a supplementary vent, not a substitute for the main stack vent.

**Q: Will this fit my 2-inch ABS drain line?**
A: Yes, the hub is sized for both 1-1/2 in. and 2 in. pipe. Use the appropriate solvent cement for your pipe material — ABS cement for ABS pipe, PVC cement for PVC.
...
👉 **[Check Price on Amazon →](https://www.amazon.com/dp/B0CW5WLCM5/?tag=tsvglyc-20)**
