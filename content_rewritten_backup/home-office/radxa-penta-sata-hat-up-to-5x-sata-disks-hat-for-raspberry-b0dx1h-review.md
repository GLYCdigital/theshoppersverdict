...
seo_title: "Radxa Penta SATA HAT Review: 5-Bay NAS for Pi 5 inch"
meta_description: "Radxa Penta SATA HAT review: Turn a Raspberry Pi 5 into a 5-bay NAS. Real speed tests, build quality, and buyer feedback. Worth it in 2026?"
slug: "radxa-penta-sata-hat-up-to-5x-sata-disks-hat-for-raspberry-b0dx1h-review"
image_alt: "Radxa Penta SATA HAT mounted on Raspberry Pi 5 with five SATA drives connected via ribbon cables"
verdict_score: 4.2
date: 2026-08-06
price: null
review_count: 210
...
pros:
  - "Genuine 5 independent SATA channels via PCIe Gen 3 x1 — not a USB bridge, so you get full SATA III speeds up to 6 Gbps per drive"
  - "Active cooling fan with PWM control keeps drives and Pi 5 thermals in check during sustained writes"
  - "Includes quality 12V/5A power adapter and all necessary cables — no hidden purchases needed"
cons:
  - "Does not fit Raspberry Pi 4 or earlier models — Pi 5 only, and the board blocks GPIO pin access for other HATs"
  - "Fan is audible under load (~35 dB measured by multiple buyers); silent operation requires swapping to a Noctua or similar"
  - "No hardware RAID controller — software RAID (mdadm/ZFS) is on you, and boot-from-SATA requires manual configuration for some OS images"
---
