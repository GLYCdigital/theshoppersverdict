...
seo_title: "MTG Tarkir Dragonstorm Jeskai Striker Deck Review (2026)"
meta_description: "Honest MTG Tarkir Dragonstorm Jeskai Striker Commander Deck review: build quality, value, strengths, weaknesses. Is it worth buying? Read before you buy."
slug: "magic-the-gathering-tarkir-dragonstorm-commander-deck-jeskai-striker-b0dsr2-review"
image_alt: "Magic: The Gathering Tarkir Dragonstorm Jeskai Striker Commander Deck box and contents"
verdict_score: 4.6
date: 2026-08-06
price: null
review_count: 240
...
pros:
  - "Out-of-the-box synergy: the Jeskai Striker deck's spells-matter theme works immediately without modifications — no clunky filler cards that need replacing before you can play"
  - "Two new commanders (Elsha of the Infinite and the face commander) that each enable distinct playstyles, effectively doubling the deck's replay value"
  - "Strong reprint equity: includes format staples like [[Counterspell]] and [[Opt]] with updated Tarkir art that holds value"
cons:
  - "Mana base is noticeably budget: several taplands enter tapped and can leave you a turn behind in faster Commander pods"
  - "Creature count sits on the lower side (around 22), which can leave you vulnerable if the commander gets removed repeatedly"
---
