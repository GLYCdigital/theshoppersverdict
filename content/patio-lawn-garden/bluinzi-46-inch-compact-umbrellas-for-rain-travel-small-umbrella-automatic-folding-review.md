...
faq:
  ...
  - question: "How big is the Bluinzi umbrella when closed?"
    answer: "When closed, the Bluinzi umbrella is compact but not mini — it will take up some space in a purse, briefcase, or bag. One reviewer described it as 'a compact size but not what I would call mini.' It's designed to fit in most standard bags but won't disappear into a pocket."
  - question: "How does the automatic open and close work on the Bluinzi umbrella?"
    answer: "The umbrella has two buttons — one to open the canopy and one to close it. The automatic close feature is less common on compact umbrellas and adds convenience, especially when getting in and out of cars. Note that the canopy opens and closes with surprising force, which may soften over time with use."
date: 2026-07-31
price: 16.99
review_count: 1106
amazon_rating: 4.6
