...
slug: "mitime-floating-shelves-set-of-3-rustic-solid-wood-floating-shelf-wall-b0d1tm-review"
image_alt: "MITIME Floating Shelves Set of 3 Rustic Solid Wood Floating Shelf Wall Storage Shelves for Living Room, Bedroom, Bathroo"
verdict_score: 4.2
date: 2026-06-17
price: null
review_count: 215
...
Three pine boards: one 17.7" and two 23.6" long, all 5.9" deep and 0.7" thick. Each shelf arrives in its own box with mounting brackets, screws, wall anchors, and a paper template. That individual boxing matters — no surface scratches from shelves banging together in transit.
...
The mounting hardware is a steel bracket that screws into your wall, with the shelf sliding over it from the front. The bracket has a lip that hooks into a routed groove on the underside of the shelf — no separate metal arms to align, no fiddly leveling once the bracket is up.
...
**The catch:** The anchors are plastic drywall plugs rated for 15 lbs per shelf. You'll want to hit a stud if you're putting anything heavier — books, records, cast iron cookware. Several buyers reported the brackets flex slightly at capacity. For decorative items, you're fine. For a dish rack, find a stud.
...
- **Scent.** That sounds odd, but multiple buyers mention the pleasant pine aroma — if you like the smell of a lumberyard, you'll enjoy this.
...
- **Renters** who want damage-conscious mounting — the included anchors leave smaller holes than most shelf systems
- **DIY decorators** who don't mind customizing the finish to match their room
- **Anyone displaying lightweight-to-moderate items** — plants, framed photos, small books, collectibles
...
**Q: Can these shelves hold books?**
A: Yes, but keep it to a single row of paperbacks or a few hardcovers. The 15-lb rating is accurate — exceeding it risks sagging if you only hit drywall.

**Q: Do the shelves work on tile or brick walls?**
A: Technically yes, but the included anchors are for drywall. You'll need masonry bits and toggle bolts for brick or tile. The bracket itself is universal.

**Q: How far apart should I space the three shelves?**
A: For visual balance, 12–16 inches of vertical gap works well. The varying lengths (one 17.7", two 23.6") give you flexibility — put the short one on top or bottom, not in the middle.
...
These shelves are a solid 80% solution — the wood and hardware are excellent, but the finish requires a bit of effort to match the photos. For the price, that's a tradeoff worth making for most buyers.

## Where to Buy

👉 **[Check Price on Amazon →](https://www.amazon.com/dp/B0D1TMV6KQ/?tag=tsvglyc-20)**
